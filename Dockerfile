...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-planeacion"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-planeacion"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-planeacion \
    KIRLET_TECHNICAL_ID=subject-planeacion \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
