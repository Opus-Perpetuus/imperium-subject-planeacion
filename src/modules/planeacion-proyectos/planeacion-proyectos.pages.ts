        ...
        props: {
          ...
          form: {
            fields: [
              ...
              { name: "start_date", component: "input-date", label: "start date" },
              ...
              { name: "invited_at", component: "input-datetime", label: "invited at" },
              ...
              { name: "progress_percentage", component: "input-number", label: "progress percentage", min: 0, max: 100 },
            ],
          },
        },
      }),
